...
data_root = {'ImageNet':"/home/Public/Dataset/ImageNet/",  # input your data root
             'Places': 'your_dir',
             'CIFAR10': 'your_dir',
             'CIFAR100': "your_dir",}

parser = argparse.ArgumentParser()
parser.add_argument('--cfg', default='./config/ImageNet_LT/vmf.yaml', type=str)
parser.add_argument('--seed', default=510, type=int)
...
config['networks']['classifier']['params'].update({'alpha': args.alpha})
if args.log_dir is not None:
    config['training_opt']['log_dir'] = args.log_dir
